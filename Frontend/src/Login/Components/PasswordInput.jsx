...
export default function PasswordInput({ name='password', value='', onChange=() => {}, visible=false, onToggle=() => {}, placeholder='Password' }){
    return (
        <div className="mt-3">
            <div className="relative">
                ...
                <button type="button" onClick={onToggle} className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 text-sm" aria-label="Toggle password visibility">
                    {visible ? (
