...
<body style="margin:0; padding:0; background: linear-gradient(135deg, #f8fafc, #f1f5f9); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif;">
<table width="100%%" cellpadding="0" cellspacing="0">
    <tr>
        <td align="center" style="padding: 40px 16px;">
            <table width="100%%" cellpadding="0" cellspacing="0" style="max-width: 520px; background-color: #ffffff; border-radius: 14px; box-shadow: 0 20px 40px rgba(0,0,0,0.5); overflow: hidden;">
                <tr>
                ...
                <tr>
                    <td style="padding: 28px 24px; text-align: center; background-color: #ffffff;">
                ...
                <tr>
                    <td style="padding: 20px 24px; text-align: center; background-color: #f9fafb;">
